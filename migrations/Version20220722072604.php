 ...
 */
final class Version20220722072604 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aln_meal (id INT AUTO_INCREMENT NOT NULL, feeder_id INT NOT NULL, planning_id INT DEFAULT NULL, distributed_on DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', time VARCHAR(5) DEFAULT NULL, amount SMALLINT NOT NULL, is_enabled TINYINT(1) NOT NULL, INDEX IDX_27A3E6D1274E059 (feeder_id), INDEX IDX_27A3E6D3D865311 (planning_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
